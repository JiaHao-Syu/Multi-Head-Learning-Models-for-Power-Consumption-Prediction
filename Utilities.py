...
def Load_Data(DF, F, T, NT, NP, FA, FT, device, MSFlag,mean,std):     
    ...
    for i in range(F, T):
        ...
        if np.shape(tmp)[0]>1000: Row.append(copy.deepcopy(tmp))
